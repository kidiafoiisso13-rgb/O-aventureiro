...
public partial class @Controles: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""DashGlitch"",
                    ""type"": ""Button"",
                    ""id"": ""dd2336b9-c82f-49b3-841b-cbb6257756ed"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""05bcd9a9-f4ec-4c8f-8e4c-a63a5e8cb928"",
                    ""path"": ""<Keyboard>/shift"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Jogador_DashGlitch = m_Jogador.FindAction("DashGlitch", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Jogador_DashGlitch;
    /// <summary>
    ...
    public struct JogadorActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Jogador/DashGlitch".
        /// </summary>
        public InputAction @DashGlitch => m_Wrapper.m_Jogador_DashGlitch;
        /// <summary>
        ...
        public void AddCallbacks(IJogadorActions instance)
        {
            ...
            @DashGlitch.started += instance.OnDashGlitch;
            @DashGlitch.performed += instance.OnDashGlitch;
            @DashGlitch.canceled += instance.OnDashGlitch;
        }
    ...
    public interface IJogadorActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "DashGlitch" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnDashGlitch(InputAction.CallbackContext context);
    }
}
